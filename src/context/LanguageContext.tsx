...
const translations: Record<Language, TranslationMap> = {
  en: {
    ...
    browseDesc: 'An optional Symaira Brain module for web work: an agent can operate the browser while you take over at any time without losing the session. Browse combines a Chrome CDP engine for real, JavaScript-heavy pages with a lightweight static fetch engine and returns clean, token-budgeted Markdown.',
    ...
    browseBtn: 'View Browse module in Brain on GitHub',
    cockpitBadge: 'Mac control',
    cockpitStatus: 'Beta',
    cockpitTitle: 'Symaira Cockpit',
    cockpitDesc: 'The native macOS hardware and system tuning tool. Cockpit tunes thermals, power, displays, focus, and cooling through a structured CLI and MCP surface.',
    cockpitBestFor: 'Mac developers who want hardware and power tuning in one structured, local tool.',
    cockpitAutomates: 'Display and focus profiles plus fan, thermal, and power policy.',
    cockpitFeature1: 'tune: display, focus, energy, and cooling profiles that switch automatically.',
    cockpitFeature2: 'history: replayable tuning history and safe profile inspection.',
    cockpitFeature3: 'doctor: verifies tuning dependencies, permissions, and local hardware support.',
    cockpitFeature4: 'Structured JSON on every command instead of output you have to scrape.',
    cockpitFeature5: 'Tune controls are exposed over MCP with the same structured contract.',
    ...
    cockpitDemoScanning: 'tune: hardware sensors ready',
    cockpitDemoConflict: 'display: focus profile applied',
    cockpitDemoThermals: 'tune: thermal pressure nominal, fans 1980 rpm',
    cockpitDemoOperate: 'power: balanced policy active',
  ...
  de: {
    ...
    brainStatus: 'Beta',
    brainTitle: 'Symaira Brain',
    brainDesc: 'Die portable Kontextschicht für KI-Coding-Harnesses. Brain stellt deine drei Zustandskerne — Gedächtnis und Entitäten, den Skill-Katalog und Vault-Credentials — hinter einem MCP-Gateway bereit. Ein Profil pro Harness entscheidet, was Claude Code, Cursor, Codex oder opencode jeweils sehen darf. Browse, Operate und Scope sind optionale, bewusst aktivierte Module.',
    ...
    browseStatus: 'Beta',
    browseTitle: 'Symaira Browse',
    browseDesc: 'Ein optionales Symaira-Brain-Modul für Webarbeit: Ein Agent kann den Browser bedienen und du übernimmst jederzeit ohne Session-Verlust. Browse kombiniert eine Chrome-CDP-Engine für echte, JavaScript-lastige Seiten mit einer schlanken Static-Fetch-Engine und liefert sauberes, token-budgetiertes Markdown.',
    ...
    browseBtn: 'Browse-Modul in Brain auf GitHub ansehen',
    cockpitBadge: 'Mac-Steuerung',
    cockpitStatus: 'Beta',
    cockpitTitle: 'Symaira Cockpit',
    cockpitDesc: 'Das native macOS-Tool für Hardware- und Systemtuning. Cockpit steuert Thermik, Energie, Displays, Fokus und Kühlung über eine strukturierte CLI- und MCP-Oberfläche.',
    cockpitBestFor: 'Mac-Entwickler, die Hardware- und Energie-Tuning in einem strukturierten lokalen Tool wollen.',
    cockpitAutomates: 'Display- und Fokus-Profile sowie Lüfter-, Thermik- und Energie-Policy.',
    cockpitFeature1: 'tune: Display-, Fokus-, Energie- und Kühlprofile, die automatisch umschalten.',
    cockpitFeature2: 'history: nachvollziehbare Tuning-Historie und sichere Profilinspektion.',
    cockpitFeature3: 'doctor: prüft Tuning-Abhängigkeiten, Berechtigungen und lokale Hardware-Unterstützung.',
    cockpitFeature4: 'Strukturiertes JSON bei jedem Befehl statt Ausgabe, die man parsen muss.',
    cockpitFeature5: 'Tune-Steuerung auch über MCP mit demselben strukturierten Vertrag.',
    ...
    cockpitDemoTitle: 'symcockpit',
    cockpitDemoScanning: 'tune: Hardware-Sensoren bereit',
    cockpitDemoConflict: 'display: Fokusprofil aktiv',
    cockpitDemoThermals: 'tune: Thermik nominal, Lüfter 1980 rpm',
    cockpitDemoOperate: 'power: Balanced-Policy aktiv',
    erasemeBadge: 'Privacy Automation',
    erasemeStatus: 'Beta',
    erasemeTitle: 'Symaira EraseMe',
